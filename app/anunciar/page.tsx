    ...
    <div style={styles.card}>
      ...
      <div style={styles.resumoGrid}>
        ...
        <div style={styles.resumoItem}>
          ...
          <span style={styles.resumoValor}>{contato.nome}</span>
        </div>
        <div style={styles.resumoItem}>
          <span style={styles.resumoLabel}>WhatsApp</span>
          <span style={styles.resumoValor}>{contato.whatsapp}</span>
        </div>
        <div style={styles.resumoItem}>
  ...
  async function publicar() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (data.upgrade) { window.location.href = "/planos"; return }
